...
Run configurator to print current device settings:
...
Change Baudrate (Bits per second, BPS) to 19200:

    # ./bt0240 -d 00:02:72:11:22:33 --bps=19200

Print settings to see
...
To use device as RS232 serial port, power it OFF and ON,
Green LED &#x1f7e9; should be ON and Yellow LED &#x2b1b; should be OFF.
Then Serial port can connect on-demand to the slave:
